...
// Materias y grados asignados al profesor que inició sesión. La asistencia es de
// la clase de cada profesor, así que solo puede tomarla en sus propias materias.
type Asignacion = {
